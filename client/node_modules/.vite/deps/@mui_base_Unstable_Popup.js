...
var TransitionContext = React6.createContext(null);
if (true) {
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React8.useState(true);
  const hasPendingExitTransition = React8.useRef(false);
  const registeredTransitions = React8.useRef(0);
  const [hasTransition, setHasTransition] = React8.useState(false);
  const previousRequestEnter = React8.useRef(requestEnter);
  React8.useEffect(() => {
  ...
  const handleExited = React8.useCallback(() => {
    hasPendingExitTransition.current = false;
    setExitTransitionFinished(true);
  }, []);
  const registerTransition = React8.useCallback(() => {
...
var PopupContext = React9.createContext(null);
if (true) {
...
var Popup = React10.forwardRef(function Popup2(props, forwardedRef) {
  const {
    anchor: anchorProp,
    children,
    container,
  ...
  const popupContextValue = React10.useMemo(() => ({
    placement: finalPlacement
  }), [finalPlacement]);
  ...
  return (0, import_jsx_runtime2.jsx)(Portal, {
    disablePortal,
    container,
    children: (0, import_jsx_runtime2.jsx)(PopupContext.Provider, {
      value: popupContextValue,
      children: (0, import_jsx_runtime2.jsx)(TransitionContext.Provider, {
        value: contextValue,
...
//# sourceMappingURL=@mui_base_Unstable_Popup.js.map
